...
### Valeur de défence
La **Valeur de défense (VD)** de votre personnage détermine sa capacité à éviter les coups, mais aussi à les encaisser sans être blessé. Entrent en jeu à la fois la Dextérité du personnage et d'éventuels bonus d'armure et de bouclier. Le chapitre [Équipement - Armures](/armures/) détaille le calcul de la classe d'armure en fonction de l'équipement du personnage. En règle générale, la VD de votre personnage est de 10 + la somme des modificateurs qui s'appliquent.
