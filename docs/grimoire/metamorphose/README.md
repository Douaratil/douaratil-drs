...
La cible possède les points d'action correspondant à sa nouvelle forme. Quand elle reprend sa forme initiale, elle se retrouve avec le nombre de points d'action qui était le sien avant la transformation. Si elle reprend sa forme initiale parce qu'elle est tombée à 0 point de vie, les éventuels dégâts en excès sont déduits des points d'action de sa forme d'origine. Tant que les dégâts en excès ne réduisent pas les points d'action normaux de la créature à 0, elle n'est pas [_inconsciente_](/gerer-la-sante-du-personnage/#inconscient).
