...
* Vous permettez à un maximum de vingt créatures situées dans votre champ de vision de récupérer la totalité de leurs points d'action et vous mettez fin à tous les effets les affectant, tel que décrit dans le sort de <ST s="restauration-superieure"/>.
